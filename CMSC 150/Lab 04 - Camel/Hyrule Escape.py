...
print("Welcome to Hyrule escape!")
print("You have infiltrated Ganon's fortress and taken the triforce which is a relic")
print("that could lead to world destruction if in the wrong hands.")
