...
"""
DISCLAIMER!!!! I DO NOT TAKE CREDIT FOR ASSETS,MUSIC,SOUNDS, and BACKGROUND IMAGES
THAT ARE SOURCED WITHIN THE CODE!!!!
        ...
        if self.current_state == GAME_RUNNING:
            if self.health > 0:
                ...
                if len(self.enemy_list) == 0:
                    ...
                    if self.level == 4:
                        """
                        Song "2ND MYSTERIOUS PLACE [UNDERTALE Q-mix]" is a remix of
                         a song in the soundtrack of undertale,
                         downloaded on youtube from a youtuber known as Rukunetsu
                        link is here https://www.youtube.com/watch?v=jfLWImAl1q0&t=38s
                        """
